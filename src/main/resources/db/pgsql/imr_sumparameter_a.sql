-- Function: imr_sumparameter_a(character varying, character varying, character varying, character varying, character varying)

-- DROP FUNCTION imr_sumparameter_a(character varying, character varying, character varying, character varying, character varying);

CREATE OR REPLACE FUNCTION imr_sumparameter_a(
...
$BODY$
  DECLARE
	 -- USAGE: select imr_sumparameter_a('FishExChange', 'Cod_survey_trawl_ecosystem_year%',  'Cod_survey_trawl_ecosystem_total', 'B010.00', 'Q20103');	 
  ...
  BEGIN
	 ...
	 END IF;
     i := 0;
     FOR v_id_parameter in select id from parameter where name like firstpartofparname_in 
     LOOP
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION imr_sumparameter_a(character varying, character varying, character varying, character varying, character varying)
  OWNER TO grid_owner;
GRANT EXECUTE ON FUNCTION imr_sumparameter_a(character varying, character varying, character varying, character varying, character varying) TO grid_owner;
GRANT EXECUTE ON FUNCTION imr_sumparameter_a(character varying, character varying, character varying, character varying, character varying) TO public;
